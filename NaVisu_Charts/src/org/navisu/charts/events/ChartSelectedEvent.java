 ...
 */
package org.navisu.charts.events;

/**
 *
 * @author Thibault
 */
public interface ChartSelectedEvent {
    
    void chartSelected(String id);
    
    public interface ChartSelectedEventSubscribe {
        
        void subscribe  (ChartSelectedEvent observer);
        void unsubscribe(ChartSelectedEvent observer);
    }
}
