...
public class WorldWindManager implements WorldWindManagerServices {

    /**
     * The Logger
     */
    private static final Logger LOG = Logger.getLogger(WorldWindManager.class.getSimpleName());
    /**
     * The WorldWindow
     */
