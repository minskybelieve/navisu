 ...
 */
package org.navisu.core.lookup;

import org.navisu.core.lookup.impl.LookupFactoryImpl;
...
public interface LookupFactory {
    ...
    <T> T lookup(Class<T> clz);
    
    public static final LookupFactory factory = new LookupFactoryImpl();
}
